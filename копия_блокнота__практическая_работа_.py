# -*- coding: utf-8 -*-
"""Копия блокнота "Практическая работа"

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1qtonpwGwejGJUJ-wkbOooBOYrGD0lxlT
"""

!git init

!git clone https://github.com/Russpecialist/Repository-.git

!ssh-keygen -t rsa -b 4096 -C "ruslan_nasyrov_2000@inbox.ru"
...
!git config --global user.email "ruslan_nasyrov_2000@inbox.ru"
!git config --global user.name "Russpecialist"

# Проверим статус и удаленные репозитории
print("=== Git Status ===")
!git status
...
GITHUB_USERNAME = "Russpecialist"
GITHUB_TOKEN = "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"
REPO_NAME = "Repository-"

# Изменяем URL удаленного репозитория для включения токена
!git remote set-url origin https://{GITHUB_USERNAME}:{GITHUB_TOKEN}@github.com/{GITHUB_USERNAME}/{REPO_NAME}.git

print("=== Testing Connection ===")
!git remote -v

!echo "# Test commit from Colab" >> test_file.txt

# 1. Устанавливаем стратегию merge
!git config pull.rebase false

# 2. Получаем изменения с merge
print("=== Pulling with merge strategy ===")
!git pull origin main

# 3. Если откроется редактор для сообщения коммита слияния, используем это:
...
# Сохраняем ваши текущие изменения в отдельную ветку
!git checkout -b my-colab-changes
!git push -u origin my-colab-changes

# Возвращаемся к main и сбрасываем до состояния origin/main
!git checkout main
!git fetch origin
!git reset --hard origin/main

# Теперь переносим ваши изменения поверх актуальной main
!git checkout my-colab-changes
!git rebase main

# Решаем конфликты если есть, затем
!git checkout main
!git merge my-colab-changes
!git push origin main
